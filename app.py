...
class_labels = {0: 'apple', 1: 'banana', 2: 'beetroot', 3: 'bell pepper', 4: 'cabbage', 5: 'capsicum', 6: 'carrot',
          ...
          14: 'grapes', 15: 'jalepeno', 16: 'kiwi', 17: 'banana', 18: 'lettuce',
...
if uploaded_file is not None:
    try:
        ...
        st.markdown(f"<h2 style='color: blue; text-align: center;'>Unable to Classify the Image</h2>", unsafe_allow_html=True)
